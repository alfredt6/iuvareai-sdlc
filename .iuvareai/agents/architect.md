...
shell copy/move commands. For image assets and diagrams, use the scoped
`iuvare_image_operation` tool rather than shell image utilities. Exact task scope
controls all reads, writes, trees,
